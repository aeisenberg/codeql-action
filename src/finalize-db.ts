...
interface QueriesStatusReport {
  // Time taken to analyze builtin queries for cpp (or undefined if this language was not analyzed)
  analyze_builtin_queries_cpp_duration?: string;
  // Time taken to analyze builtin queries for csharp (or undefined if this language was not analyzed)
  analyze_builtin_queries_csharp_duration?: string;
  // Time taken to analyze builtin queries for go (or undefined if this language was not analyzed)
  analyze_builtin_queries_go_duration?: string;
  // Time taken to analyze builtin queries for java (or undefined if this language was not analyzed)
  analyze_builtin_queries_java_duration?: string;
  // Time taken to analyze builtin queries for javascript (or undefined if this language was not analyzed)
  analyze_builtin_queries_javascript_duration?: string;
  // Time taken to analyze builtin queries for python (or undefined if this language was not analyzed)
  analyze_builtin_queries_python_duration?: string;
  // Time taken to analyze custom queries for cpp (or undefined if this language was not analyzed)
  analyze_custom_queries_cpp_duration?: string;
  // Time taken to analyze custom queries for csharp (or undefined if this language was not analyzed)
  analyze_custom_queries_csharp_duration?: string;
  // Time taken to analyze custom queries for go (or undefined if this language was not analyzed)
  analyze_custom_queries_go_duration?: string;
  // Time taken to analyze custom queries for java (or undefined if this language was not analyzed)
  analyze_custom_queries_java_duration?: string;
  // Time taken to analyze custom queries for javascript (or undefined if this language was not analyzed)
  analyze_custom_queries_javascript_duration?: string;
  // Time taken to analyze custom queries for python (or undefined if this language was not analyzed)
  analyze_custom_queries_python_duration?: string;
